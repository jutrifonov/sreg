...
![version](https://img.shields.io/badge/sreg-v.0.7.4-green?style=flat&logo=github&labelColor=2A2523)
...
[Latest Build (v.0.7.3)](.github/package/sreg_0.7.3.tar.gz)
...
#> \___ \| |_) |  _|| |  _  
#>  ___) |  _ <| |__| |_| |  
#> |____/|_| \_\_____\____| version 0.7.1                           
```
