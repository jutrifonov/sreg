...
✅ Sketch of the derivation of the ATE as. variance estimator under the cluster-level treatment assignment: [Download PDF](https://github.com/yurytrifonov/sreg.dev/blob/main/cluster.pdf)
