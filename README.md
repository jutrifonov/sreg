...
✔️ A sketch of the derivation of the ATE variance estimator under cluster-level treatment assignment: [Download PDF](https://github.com/yurytrifonov/sreg.dev/blob/main/cluster.pdf)
