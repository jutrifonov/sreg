...
# Test 2. data: large strata, option: large strata
...
# Test 3. data: small strata, option: large strata
set.seed(123)
tau.vec = c(0.2, 0.8)
n.treat = length(tau.vec)
n_1 = 900
...
# Test 4. data: large strata, option: small strata
tau.vec = c(0.2, 0.9)
n.treat = length(tau.vec)
n_1 = 1000
...
# Test 6. data: mixed design, option: large strata (just a large-strata estimator, but should throw a warning that estimators are invalid!)
...
# Test 4. data: large strata, option: small strata (should not work and throw a warning)
tau.vec = c(0.2, 0.9)
n.treat = length(tau.vec)
n_1 = 1000
...
# Test 6. data: mixed design, option: large strata (just a large-strata estimator!)
