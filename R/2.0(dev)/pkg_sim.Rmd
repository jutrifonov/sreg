...
data <- sreg.rgen(n = 1200, tau.vec = c(1.2), n.strata = 4, cluster = FALSE, small.strata = TRUE, treat.sizes = c(1, 1), k = 2)
Y <- data$Y
...
dtapm <- sreg.rgen(n = 100, tau.vec = c(1.2, 0.8), cluster = TRUE, small.strata = FALSE, k = 2, treat.sizes = c(1, 1))
