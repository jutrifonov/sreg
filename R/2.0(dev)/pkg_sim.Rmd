...
X <- data.frame("x_1" = data_df$x_1, "x_2" = data_df$x_2, 'bor' = rnorm(24, 2, 1), 'god' = rnorm(24, 3, 1), 'bro'= rnorm(24, 3, 1), 'bro1'= rnorm(24, 3, 1), 'bro2'= rnorm(24, 3, 1), 'bro3' = rnorm(24, 5, 2))
...
sreg(Y, S, D, G.id = NULL, Ng = NULL, X, HC1 = TRUE, small.strata = TRUE)
...
for (s in 1:nsim)
{
  ...
  X <- data.frame('Ng' = data_cl$Ng, 'x_1' = data_cl$x_1, 'x_2' = data_cl$x_2)
sreg(Y, S, D, G.id, Ng = Ng, X = X, HC1 = TRUE, small.strata = TRUE)
...
sreg(Y, S, D, G.id = G.id, Ng = NULL, X = X)
print(result)
