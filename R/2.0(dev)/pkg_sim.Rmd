...
agg_result <- res.sreg.ss(Y, S, D, X = NULL, HC1 = TRUE)
agg_result

sreg(Y, S, D, G.id = NULL, Ng = NULL, X = X, HC1 = TRUE, small.strata = TRUE)
...
for (s in 1:nsim)
{
  ...
  sreg(Y, S, D, G.id, Ng, X = NULL, HC1 = TRUE, small.strata = TRUE)
