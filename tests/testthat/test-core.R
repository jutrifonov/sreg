test_that("simulations without clusters work", {
  ...
  expect_equal(round(result$se.rob, 8), c(0.07567160, 0.07651933))
  ...
  expect_equal(round(result$se.rob, 8), c(0.08256039, 0.08329688))
...
test_that("simulations with clusters work", {
  ...
  expect_equal(round(result$se.rob, 7), c(0.1554919, 0.2473806))
  ...
  expect_equal(round(result$se.rob, 7), c(0.3127582, 0.3280368))
  ...
  expect_equal(round(result$se.rob, 7), c(0.1642364, 0.1667535))
  ...
  expect_equal(round(result$se.rob, 7), c(0.3048313, 0.3096932))
  ...
  expect_equal(round(result$se.rob, 8), c(0.06220343, 0.05958632))
  ...
  expect_equal(round(result$se.rob, 7), c(0.1421541, 0.1377763))
...
test_that("empirical example works", {
  ...
  expect_equal(round(result$se.rob, 7), c(0.1816173, 0.1857249))
...
test_that("data: large strata, option: large strata", {
  ...
  expect_equal(round(result$se.rob, 7), c(0.0889232, 0.0887789, 0.0890084))
  invisible(capture.output({
    result <- sreg(Y = sim_data$Y, D = sim_data$D, S = sim_data$S, X = data.frame(sim_data$x_1, sim_data$x_2), HC1 = FALSE, small.strata = FALSE)
  }))
  expect_equal(round(result$tau.hat, 7), c(0.2114763, 0.8411237, 1.4103687))
  expect_equal(round(result$se.rob, 7), c(0.0882149, 0.0880689, 0.0882998))
  invisible(capture.output({
...
test_that("data: mixed design, option: small strata", {
  ...
  expect_equal(round(result$se.rob, 7), c(0.0450014, 0.0451773))
  ...
  expect_equal(round(result$tau.hat, 7), c(0.1679006, 0.8306431))
  expect_equal(round(result$se.rob, 7), c(0.0448930, 0.0450852))
...
test_that("data: mixed design, option: large strata", {
  ...
  expect_equal(round(result$se.rob, 7), c(0.0483446, 0.0477400))
  ...
  expect_equal(round(result$tau.hat, 7), c(0.1644669, 0.8312292))
  expect_equal(round(result$se.rob, 7), c(0.0483209, 0.0477165))
...
test_that("data: large strata, option: large strata", {
  ...
  expect_equal(round(result$se.rob, 7), c(0.1076932, 0.1079555, 0.1073066))

  result <- sreg(Y = data_sim$Y, D = data_sim$D, S = data_sim$S, HC1 = FALSE, G.id = data_sim$G.id, Ng = data_sim$Ng, small.strata = FALSE)
  expect_equal(round(result$tau.hat, 7), c(0.1366736, 1.0663200, 1.5402160))
  expect_equal(round(result$se.rob, 7), c(0.1068337, 0.1070917, 0.1064449))
  ...
  expect_equal(round(result$se.rob, 7), c(0.0526367, 0.0555112, 0.0614008))
  ...
  expect_equal(round(result$tau.hat, 7), c(0.0695722, 0.8947400, 1.3867602))
  expect_equal(round(result$se.rob, 7), c(0.0522258, 0.0550760, 0.0609110))
  ...
  expect_equal(round(result$se.rob, 7), c(0.0683037, 0.0696617, 0.0654361))
  ...
  expect_equal(round(result$se.rob, 7), c(0.0624957, 0.0643839, 0.0692138))
...
test_that("data: small strata, option: large strata", {
  ...
  expect_equal(round(result$tau.hat, 7), c(0.1399429, 0.8776288))
  expect_equal(round(result$se.rob, 7), c(0.0572068, 0.0595471))
...
test_that("data: mixed design, option: small strata", {
  ...
  expect_equal(round(result$tau.hat, 7), c(0.1299086, 0.9257989))
  expect_equal(round(result$se.rob, 7), c(0.0553738, 0.0561211))
  ...
  expect_equal(round(result$tau.hat, 7), c(0.1280123, 0.8938856))
  expect_equal(round(result$se.rob, 7), c(0.0545363, 0.0605790))
  invisible(
    suppressWarnings(
      capture.output({
  ...
  expect_equal(round(result$se.rob, 7), c(0.1149836, 0.1133392))
  ...
  expect_equal(round(result$tau.hat, 7), c(-0.0747915, 0.7039973))
  expect_equal(round(result$se.rob, 7), c(0.1163971, 0.1142527))
  ...
  expect_equal(round(result$tau.hat, 7), c(0.1280123, 0.8938856))
  expect_equal(round(result$se.rob, 7), c(0.0551575, 0.0612854))
  invisible(
    suppressWarnings(
      capture.output({
...
test_that("data: mixed design, option: large strata", {
  ...
  expect_equal(round(result$tau.hat, 7), c(-0.0747915, 0.7039973))
  expect_equal(round(result$se.rob, 7), c(0.1810787, 0.1474668))
  ...
  expect_equal(round(result$tau.hat, 7), c(-0.0747915, 0.7039973))
  expect_equal(round(result$se.rob, 7), c(0.0746145, 0.0716710))
  ...
  expect_equal(round(result$se.rob, 7), c(0.1168944, 0.1126999))
