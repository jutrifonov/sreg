...
# %# v.1.2.0
# %##%##%##%##
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/100.RData')
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/250.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/500.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/750.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/1000.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/1500.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/2000.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/3000.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/v.1.2.0/sreg.cov/4000.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
tau.4000 <- rowMeans(tau)
se.num.4000 <- apply(tau, 1, sd)
