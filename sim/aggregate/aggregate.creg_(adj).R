...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/creg/adj/new version/100.RData')
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/creg/adj/new version/250.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/creg/adj/new version/500.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/creg/adj/new version/750.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/creg/adj/new version/1000.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/creg/adj/new version/2000.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/creg/adj/new version/3000.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
