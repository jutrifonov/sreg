...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/sreg/100.RData')
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/sreg/250.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/sreg/500.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/sreg/750.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/sreg/1000.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
load('/Users/trifonovjuri/Desktop/sreg.source/mc.files/res/sreg/1500.RData')
tau <- na.omit(as.matrix(sapply(simres, function(simres) simres$tau)))
se <- na.omit(as.matrix(sapply(simres, function(simres) simres$se)))
ci.hit <- na.omit(as.matrix(sapply(simres, function(simres) simres$ci.hit)))
...
tau_1.vec <- c(tau.100[1], tau.250[1], tau.500[1], tau.750[1],
            tau.1000[1], tau.1500[1])
tau_2.vec <- c(tau.100[2], tau.250[2], tau.500[2], tau.750[2],
               tau.1000[2], tau.1500[2])
se.num_1.vec <- c(se.num.100[1], se.num.250[1], se.num.500[1], se.num.750[1],
                se.num.1000[1], se.num.1500[1])
se.num_2.vec <- c(se.num.100[2], se.num.250[2], se.num.500[2], se.num.750[2],
                  se.num.1000[2], se.num.1500[2])
se.analyt_1.vec <- c(se.analyt.100[1], se.analyt.250[1], se.analyt.500[1], se.analyt.750[1], se.analyt.1000[1], se.analyt.1500[1])
se.analyt_2.vec <- c(se.analyt.100[2], se.analyt.250[2], se.analyt.500[2], se.analyt.750[2], se.analyt.1000[2], se.analyt.1500[2])
ci.hit_1.vec <- c(ci.hit.100[1], ci.hit.250[1], ci.hit.500[1], ci.hit.750[1], ci.hit.1000[1], ci.hit.1500[1])
ci.hit_2.vec <- c(ci.hit.100[2], ci.hit.250[2], ci.hit.500[2], ci.hit.750[2], ci.hit.1000[2], ci.hit.1500[2])
sample.set <- c(100, 250, 500, 750, 1000, 1500)
